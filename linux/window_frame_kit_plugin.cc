...
#define WINDOW_FRAME_KIT_PLUGIN(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), window_frame_kit_plugin_get_type(), \
                              WindowFrameKitPlugin))

struct _WindowFrameKitPlugin {
  ...
  bool _is_frameless;
  // // FRAME: custom-frame save/restore state (04-03) - reversible toggle.
  bool _custom_frame_on;
  bool _saved_decorated;
...
G_DEFINE_TYPE(WindowFrameKitPlugin, window_frame_kit_plugin, g_object_get_type())

// Gets the window being controlled.
GtkWindow* get_window(WindowFrameKitPlugin* self) {
...
GdkWindow* get_gdk_window(WindowFrameKitPlugin* self) {
  return gtk_widget_get_window(GTK_WIDGET(get_window(self)));
}

static FlMethodResponse* set_as_frameless(WindowFrameKitPlugin* self,
                                          FlValue* args) {
  // DEV: upstream 0.5.2 declares _is_frameless but never assigns it here
  // (dead field); assigning keeps the flag truthful for future state queries.
...
// // FRAME: custom-frame toggle (04-03) - snapshots the pre-toggle decorated
// state exactly once, strips decorations while on, restores verbatim on
// disable. Reversible, unlike set_as_frameless (upstream 0.5.2's
// set_title_bar_style assumes the window was originally decorated).
static FlMethodResponse* set_custom_frame(WindowFrameKitPlugin* self,
                                          FlValue* args) {
  GtkWindow* window = get_window(self);
  if (window == nullptr) {
    return FL_METHOD_RESPONSE(
        fl_method_error_response_new("setCustomFrame", "window not ready",
                                     nullptr));
  }
  const bool is_custom_frame = fl_value_get_bool(
      fl_value_lookup(args, fl_value_new_string("isCustomFrame")));
  if (is_custom_frame) {
    if (!self->_custom_frame_on) {  // idempotent: snapshot exactly once
      self->_saved_decorated = gtk_window_get_decorated(window);
      self->_custom_frame_on = true;
    }
    gtk_window_set_decorated(window, false);
  } else {
    if (self->_custom_frame_on) {
      gtk_window_set_decorated(window, self->_saved_decorated);
      self->_custom_frame_on = false;
    }
  }
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
...
static FlMethodResponse* destroy(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* close(WindowFrameKitPlugin* self) {
  gtk_window_close(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_prevent_close(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_prevent_close);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_prevent_close(WindowFrameKitPlugin* self,
                                           FlValue* args) {
...
static FlMethodResponse* focus(WindowFrameKitPlugin* self) {
  gtk_window_present(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* blur(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_focused(WindowFrameKitPlugin* self) {
  bool is_focused = gtk_window_is_active(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_focused);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* show(WindowFrameKitPlugin* self) {
  gtk_widget_show(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* hide(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* is_visible(WindowFrameKitPlugin* self) {
  bool is_visible = gtk_widget_is_visible(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_bool(is_visible);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_maximized(WindowFrameKitPlugin* self) {
  bool is_maximized = gtk_window_is_maximized(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_maximized);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* maximize(WindowFrameKitPlugin* self) {
  gtk_window_maximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* unmaximize(WindowFrameKitPlugin* self) {
  gtk_window_unmaximize(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_minimized(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* minimize(WindowFrameKitPlugin* self) {
  gtk_window_iconify(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_dockable(WindowFrameKitPlugin* self) {
  bool is_docked = false;
  g_autoptr(FlValue) result = fl_value_new_bool(is_docked);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* is_docked(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_null();
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* dock(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* undock(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(true);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* restore(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* is_full_screen(WindowFrameKitPlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
  g_autoptr(FlValue) result =
...
static FlMethodResponse* set_full_screen(WindowFrameKitPlugin* self,
                                         FlValue* args) {
  bool is_full_screen =
...
static FlMethodResponse* set_aspect_ratio(WindowFrameKitPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_background_color(WindowFrameKitPlugin* self,
                                              FlValue* args) {
  GdkRGBA rgba;
...
static FlMethodResponse* get_bounds(WindowFrameKitPlugin* self) {
  gint x, y, width, height;
  gtk_window_get_position(get_window(self), &x, &y);
  gtk_window_get_size(get_window(self), &width, &height);
...
static FlMethodResponse* set_bounds(WindowFrameKitPlugin* self, FlValue* args) {
...
static FlMethodResponse* set_minimum_size(WindowFrameKitPlugin* self,
                                          FlValue* args) {
...
static FlMethodResponse* set_maximum_size(WindowFrameKitPlugin* self,
                                          FlValue* args) {
  const float width = fl_value_get_float(fl_value_lookup_string(args, "width"));
  const float height =
      fl_value_get_float(fl_value_lookup_string(args, "height"));
...
static FlMethodResponse* is_resizable(WindowFrameKitPlugin* self) {
  bool is_resizable = gtk_window_get_resizable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_resizable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_resizable(WindowFrameKitPlugin* self,
                                       FlValue* args) {
  bool is_resizable =
...
static FlMethodResponse* is_minimizable(WindowFrameKitPlugin* self) {
  GdkWindowState state = gdk_window_get_state(get_gdk_window(self));
...
static FlMethodResponse* set_minimizable(WindowFrameKitPlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_maximizable(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* set_maximizable(WindowFrameKitPlugin* self,
                                         FlValue* args) {
...
static FlMethodResponse* is_closable(WindowFrameKitPlugin* self) {
  bool is_closable = gtk_window_get_deletable(get_window(self));
  g_autoptr(FlValue) result = fl_value_new_bool(is_closable);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_closable(WindowFrameKitPlugin* self,
                                      FlValue* args) {
  bool is_closable =
...
static FlMethodResponse* is_always_on_top(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_always_on_top);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_always_on_top(WindowFrameKitPlugin* self,
                                           FlValue* args) {
  bool isAlwaysOnTop =
...
static FlMethodResponse* is_always_on_bottom(WindowFrameKitPlugin* self) {
  g_autoptr(FlValue) result = fl_value_new_bool(self->_is_always_on_bottom);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_always_on_bottom(WindowFrameKitPlugin* self,
                                              FlValue* args) {
...
static FlMethodResponse* get_title(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* set_title(WindowFrameKitPlugin* self, FlValue* args) {
  const gchar* title =
...
static FlMethodResponse* set_title_bar_style(WindowFrameKitPlugin* self,
                                             FlValue* args) {
...
static FlMethodResponse* get_title_bar_height(WindowFrameKitPlugin* self,
                                              FlValue* args) {
...
static FlMethodResponse* is_skip_taskbar(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* set_skip_taskbar(WindowFrameKitPlugin* self,
                                          FlValue* args) {
  bool isSkipTaskbar =
...
static FlMethodResponse* set_icon(WindowFrameKitPlugin* self, FlValue* args) {
...
static FlMethodResponse* get_opacity(WindowFrameKitPlugin* self) {
  gdouble opacity = gtk_widget_get_opacity(GTK_WIDGET(get_window(self)));
  g_autoptr(FlValue) result = fl_value_new_float(opacity);
  return FL_METHOD_RESPONSE(fl_method_success_response_new(result));
}

static FlMethodResponse* set_opacity(WindowFrameKitPlugin* self, FlValue* args) {
...
static FlMethodResponse* pop_up_window_menu(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* start_dragging(WindowFrameKitPlugin* self) {
...
static void find_event_box(WindowFrameKitPlugin* plugin, GtkWidget* widget) {
  GList* children = NULL;
...
static FlMethodResponse* start_resizing(WindowFrameKitPlugin* self,
                                        FlValue* args) {
...
static GdkGrabStatus gdk_grab_keyboard(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* grab_keyboard(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* ungrab_keyboard(WindowFrameKitPlugin* self) {
...
static FlMethodResponse* set_brightness(WindowFrameKitPlugin* self,
                                        FlValue* args) {
...
static void window_frame_kit_plugin_handle_method_call(
    WindowFrameKitPlugin* self,
  ...
  } else if (g_strcmp0(method, "setCustomFrame") == 0) {
    // // FRAME: graft entry (04-03) - reversible decoration toggle.
...
static void window_frame_kit_plugin_dispose(GObject* object) {
  WindowFrameKitPlugin* self = WINDOW_FRAME_KIT_PLUGIN(object);
  g_clear_object(&self->css_provider);
  g_free(self->title_bar_style_);
  G_OBJECT_CLASS(window_frame_kit_plugin_parent_class)->dispose(object);
}

static void window_frame_kit_plugin_class_init(WindowFrameKitPluginClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = window_frame_kit_plugin_dispose;
}

static void window_frame_kit_plugin_init(WindowFrameKitPlugin* self) {}

static void method_call_cb(FlMethodChannel* channel,
                           FlMethodCall* method_call,
                           gpointer user_data) {
  WindowFrameKitPlugin* plugin = WINDOW_FRAME_KIT_PLUGIN(user_data);
  window_frame_kit_plugin_handle_method_call(plugin, method_call);
}

void _emit_event(WindowFrameKitPlugin* plugin, const char* event_name) {
  g_autoptr(FlValue) result_data = fl_value_new_map();
...
gboolean on_window_close(GtkWidget* widget, GdkEvent* event, gpointer data) {
  WindowFrameKitPlugin* plugin = WINDOW_FRAME_KIT_PLUGIN(data);
...
void emit_button_release(WindowFrameKitPlugin* self) {
...
void window_frame_kit_plugin_register_with_registrar(
    FlPluginRegistrar* registrar) {
  WindowFrameKitPlugin* plugin = WINDOW_FRAME_KIT_PLUGIN(
      g_object_new(window_frame_kit_plugin_get_type(), nullptr));
  ...
  plugin->channel =
      fl_method_channel_new(fl_plugin_registrar_get_messenger(registrar),
                            "window_frame_kit", FL_METHOD_CODEC(codec));
