...
fixed_count: 2
total_count: 7
last_updated: 2026-09-05T04:39:05.252Z
---
...
| 5 | 1 | todo | pubspec.yaml |  | pana 基线 140/160（Phase 2 02-01 重钉 threshold 20，CI run 33906880498）：①description 超 180 字符建议长度扣 0/10 ②逐字区 lib/src 不匹配 tall-style formatter 扣 40/50（SC5 字节级 verbatim 的结构性代价，pana format 检查无豁免机制）——Phase 5 PUB-04 精简 description 后把 ci.yml 的 pana exit-code-threshold 重钉为 160 − 新基线 | open |  | 2026-09-04T13:18:21.677Z |  |
...
| 7 | 2 | todo | example/lib/pages/home.dart |  | example 移除系统托盘（用户指令 2026-09-05）→ 02-05 执行；需替代 CAPB-11 穿透恢复路径（候选：定时自动复位/快捷键）+ ci.yml ubuntu leg 的 libayatana-appindicator3-dev 依赖同步移除 + registrant 再生成同 commit | open |  | 2026-09-05T04:39:05.252Z |  |
...
[
  ...
  },
  {
    ...
    "line": null,
    "description": "example 移除系统托盘（用户指令 2026-09-05）→ 02-05 执行；需替代 CAPB-11 穿透恢复路径（候选：定时自动复位/快捷键）+ ci.yml ubuntu leg 的 libayatana-appindicator3-dev 依赖同步移除 + registrant 再生成同 commit",
    "status": "open",
    "reason": "",
